...
data class HardwareInfo(
    val computerSystem: ComputerSystemDetails,
    val processor: ProcessorDetails,
    val memory: MemoryDetails,
    val battery: BatteryDetails?,
    val displays: List<DisplayInfo>
){
    constructor(computerSystem: ComputerSystemDetails, processor: ProcessorDetails, memory: MemoryDetails, displays: List<DisplayInfo>) : this(computerSystem, processor, memory, null, displays)
}
